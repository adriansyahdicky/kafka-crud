package com.project.kafka.kafka_crud.config;
...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        configProps.put(schemaRegistryUrlKey, schemaRegistryUrl);
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        configMap.put(ConsumerConfig.GROUP_ID_CONFIG, "employee-consumer-group");
